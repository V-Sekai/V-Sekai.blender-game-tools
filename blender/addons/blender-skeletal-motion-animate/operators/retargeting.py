...
class RenameStandardBonesVRM(bpy.types.Operator):
    bl_idname = "rsl.rename_standard_bones_vrm"
    bl_label = "Rename Standard Bones VRM "
    bl_description = "Tries to automatically rename standards bones to vrm"
    bl_options = {'REGISTER', 'UNDO', 'INTERNAL'}

    def execute(self, context):
        armature_source = get_source_armature()

        if not armature_source:
            self.report({'ERROR'}, 'No source armature found!'
                                   '\nSelect an source armature.')
            return {'CANCELLED'}
        ...
        for prop_id in standard_bones:
            pb = armature_source.pose.bones.get(prop_id)
            if pb is None:
                continue
            pb.name = standard_to_vrm[prop_id]
...
class RenameVRMBonesMMD(bpy.types.Operator):
    bl_idname = "rsl.rename_vrm_bones_mmd"
    bl_label = "Rename VRM Bones MMD"
    bl_description = "Tries to automatically rename vrm bones to mmd"
    bl_options = {'REGISTER', 'UNDO', 'INTERNAL'}
    ...
    def execute(self, context):
        ...
        vrm_to_mmd = {
            ...
            "leftEye" : "目.L",
            "rightEye" : "目.R",
            "leftThumbProximal" : "親指０.L",
            "leftThumbIntermediate" : "親指1.L",
            "leftThumbDistal" : "親指2.L",
            "leftIndexProximal" : "人指1.L",
            "leftIndexIntermediate" : "人指2.L",
            "leftIndexDistal" : "人指3.L",
            "leftMiddleProximal" : "中指１.L",
            "leftMiddleIntermediate" : "中指２.L",
            "leftMiddleDistal" : "中指３.L",
            "leftRingProximal" : "薬指１.L",
            "leftRingIntermediate" : "薬指２.L",
            "leftRingDistal" : "薬指３.L",
            "leftLittleProximal" : "小指１.L",
            "leftLittleIntermediate" : "小指２.L",
            "leftLittleDistal" : "小指３.L",
            "rightThumbProximal" : "親指０.R",
            "rightThumbIntermediate" : "親指１.R",
            "rightThumbDistal" : "親指２.R",
            "rightIndexProximal" : "人指１.R",
            "rightIndexIntermediate" : "人指２.R",
            "rightIndexDistal" : "人指３.R",
            "rightMiddleProximal" : "中指１.R",
            "rightMiddleIntermediate" : "中指２.R",
            "rightMiddleDistal" : "中指３.R",
            "rightRingProximal" : "薬指１.R",
            "rightRingIntermediate" : "薬指２.R",
            "rightRingDistal" : "薬指３.R",
            "rightLittleProximal" : "小指１.R",
            "rightLittleIntermediate" : "小指２.R",
            "rightLittleDistal" : "小指３.R",
        }

        for prop_id in vrm_bones:
            pb = armature_source.pose.bones.get(prop_id)
            if pb is None:
                continue
            pb.name = vrm_to_mmd[prop_id]
