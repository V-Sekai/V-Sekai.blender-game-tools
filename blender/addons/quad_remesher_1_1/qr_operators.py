...
def getQREngineFolder():
    ...
    if (isMacOS):
        ...
        engineFolder = os.path.expanduser("~/.local/share/Exoside/QuadRemesher/Datas_Blender/QuadRemesherEngine_1.1")
        #engineFolder = "/home/maxime/.local/share/Exoside/QuadRemesher/Datas_Blender/QuadRemesherEngine_1.1"
    else:
	...
	if not os.path.exists(enginePath):
		...
		try:
			...
			if isMacOSX:
				...
				urllib.request.urlretrieve("http://exoside.com/quadremesherdata/quad_remesher_engine_1.1_linux.zip", zip_file_name)
			else:
