...
def SetupWorldSpaceControllers(pboneList):
    ...
    newBones, newEditBones, newBoneNames = duplicateBone.DuplicateBone("World.", eboneList)
...
def RemoveWorld(targetPoseBonesWithWorld):
    ...
    for targetPBone in targetPoseBonesWithWorld:
        ...
        bonesToBakeInfo[targetPBone] = [
                [worldtargetPBone, rotfBake.Channel.locationXYZ, rotfBake.Channel.locationXYZ],
                [worldtargetPBone, rotfBake.Channel.rotationQE, rotfBake.Channel.rotationQE],
                [worldtargetPBone, rotfBake.Channel.scaleXYZ, rotfBake.Channel.scaleXYZ]
                ]
