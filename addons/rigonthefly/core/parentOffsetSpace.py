...
def SetupParentOffsetSpaceControllers(parentSettingsList):
    ...
    for parentSettings in parentSettingsList:
        ...
        newBones, newEditBones, newBoneNames = duplicateBone.DuplicateBones("Child.", [ebone])
    ...
    for parentSettings in parentSettingsList:
        ...
        if appVersion[0] == 4:
            boneCollections.AddBoneToCollections(parentPBone.bone, [boneCollections.RotFAnimationColName,
                                                                    boneCollections.RotFOnlyColName])
            
        elif appVersion[0] == 3:
            parentPBone.bone.layers = pbone.bone.layers
        ...
        bonesToBakeInfo[parentPBone] = [pbone]
