...
def ChangeRotationAndScaleMode(boneNamesDict, rotationModeDict, inheritRotationDict, inheritScaleDict):
    ...
    for obj in boneNamesDict:
        ...
        newBones, newEditBones, newBoneNames = duplicateBone.DuplicateBones("temp.", eboneList) #duplicate bones to change
    ...
    for obj in boneNamesDict:
        ...
        for boneN in boneNamesDict[obj]:
            ...
            if rotationModeDict or inheritRotationDict: #if RotationModeAndRelationsDict or inheritRotationDict is not null constrain rotation
                ...
                tempBonesToBakeInfo[tempPBone].append(selectedPBone)
    ...
    for obj in boneNamesDict:
        ...
        for i, boneN in enumerate(boneNamesDict[obj]):
            ...
            if inheritScaleDict:
                selectedPBone.bone.inherit_scale = inheritScaleDict[obj][i] #change selected bones' inherit scale
                if orientedPBone:
            ...
            if rotationModeDict or inheritRotationDict: #if RotationModeAndRelationsDict or inheritRotationDict is not null constrain rotation
                ...
                selectedBonesToBakeInfo[selectedPBone].append(tempPBone)
