...
def SetupAimSpaceControllers(aimSettingsList):
    ...
    for aimSettings in aimSettingsList:
        ...
        newBones, newEditBones, newBoneNames = duplicateBone.DuplicateBones("AimTarget.", [ebone])
        ...
        newBones, newEditBones, newBoneNames = duplicateBone.DuplicateBones("Temp.", [ebone])
...
def RemoveAim(removeAimInfoList):
    ...
    for removeAimInfo in removeAimInfoList:
        ...
        bonesToBakeInfo[pbone] = [aimTargetPBone]
