...
def SetupAimOffsetSpaceControllers(aimSettingsList):
    ...
    for aimSettings in aimSettingsList:
        ...
        aimTargetEBone.layers = ebone.layers
        ...
        newBones, newEditBones, newBoneNames = duplicateBone.DuplicateBone("AimOffset.", [ebone])
    ...
    for aimSettings in aimSettingsList:
        ...
        bonesToBakeInfo[offsetPBone] = [[targetPBone, rotfBake.Channel.locationXYZ, rotfBake.Channel.locationXYZ],
