...
#Settings
SETTINGS_File_Name = "Hand.blend"
SETTINGS_Default_Name = "Hand"
SETTINGS_Maximum = 7
SETTINGS_Default = 3
SETTINGS_ID_Name = "mesh.human_primitive_bodypart_hand"
SETTINGS_Label = "Add Hand"
...
class HP_OT_BodyPart_Hand(bpy.types.Operator):
    """Add Hand"""
    ...
    def execute(self, context):
        ...
        if mode == "OBJECT":
            ...
            filename = "HAND_0" + str(self.version + 1) + Armaute_Choice 
