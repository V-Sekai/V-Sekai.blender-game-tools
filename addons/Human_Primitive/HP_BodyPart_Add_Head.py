...
#Settings
SETTINGS_File_Name = "Head.blend"
SETTINGS_Default_Name = "Head"
SETTINGS_Maximum = 4
SETTINGS_Default = 3
SETTINGS_ID_Name = "mesh.human_primitive_bodypart_head"
SETTINGS_Label = "Add Head"
...
class HP_OT_BodyPart_Add_Head(bpy.types.Operator):
    """Add Head"""
...
classes = [HP_OT_BodyPart_Add_Head]
