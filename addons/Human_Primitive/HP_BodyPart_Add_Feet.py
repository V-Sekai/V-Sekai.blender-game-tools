...
#Settings
SETTINGS_File_Name = "Feet.blend"
SETTINGS_Default_Name = "Feet"
SETTINGS_Maximum = 7
SETTINGS_Default = 3
SETTINGS_ID_Name = "mesh.human_primitive_bodypart_feet"
SETTINGS_Label = "Add Feet"
...
class HP_OT_BodyPart_Add_Feet(bpy.types.Operator):
    """Add Feet""" 
...
classes = [HP_OT_BodyPart_Add_Feet]
