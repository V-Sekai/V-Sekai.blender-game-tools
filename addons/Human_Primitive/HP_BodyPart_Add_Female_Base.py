...
SETTINGS_Maximum = 3
SETTINGS_Default = 1
SETTINGS_ID_Name = "mesh.human_primitive_basehuman_female"
...
class HP_OT_BodyPart_Add_Female_Human(bpy.types.Operator):
    """Add Female Base"""
    ...
    def execute(self, context):
        ...
        if mode == "OBJECT":
            ...
            filename = self.Pose + "Female_0" + str(self.version + 1) + Armaute_Choice 
...
classes = [HP_OT_BodyPart_Add_Female_Human]
