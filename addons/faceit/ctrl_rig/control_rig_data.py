...
# def get_bone_dict():
#     if bpy.context.scene.faceit_asymmetric:
#         return match_bones_asymmetry_dict
#     else:
#         return match_bones_symmetry_dict

# all driver settings per shape... Also, maximum range of the spec bone.
# driver type in [‘AVERAGE’, ‘SUM’, ‘SCRIPTED’, ‘MIN’, ‘MAX’]
# variable type in [‘SINGLE_PROP’, ‘TRANSFORMS’, ‘ROTATION_DIFF’, ‘LOC_DIFF’]
# target - variable data_path = key_blocks["{}"].value
# target - variable transform_space in [‘WORLD_SPACE’, ‘TRANSFORM_SPACE’, ‘LOCAL_SPACE’]
# target - variable transform_type in [‘LOC_X’, ‘LOC_Y’, ‘LOC_Z’, ‘ROT_X’, ‘ROT_Y’, ‘ROT_Z’, ‘ROT_W’, ‘SCALE_X’, ‘SCALE_Y’, ‘SCALE_Z’, ‘SCALE_AVG’]
# target - variable rotation_mode in [‘AUTO’, ‘XYZ’, ‘XZY’, ‘YXZ’, ‘YZX’, ‘ZXY’, ‘ZYX’, ‘QUATERNION’, ‘SWING_TWIST_X’, ‘SWING_TWIST_Y’, ‘SWING_TWIST_Z’]
# target - variable id_type in enum in [‘ACTION’, ‘ARMATURE’, ‘BRUSH’, ‘CAMERA’, ‘CACHEFILE’, ‘CURVE’, ‘FONT’, ‘GREASEPENCIL’, ‘COLLECTION’, ‘IMAGE’, ‘KEY’, ‘LIGHT’, ‘LIBRARY’, ‘LINESTYLE’,
# ‘LATTICE’, ‘MASK’, ‘MATERIAL’, ‘META’, ‘MESH’, ‘MOVIECLIP’, ‘NODETREE’, ‘OBJECT’, ‘PAINTCURVE’, ‘PALETTE’, ‘PARTICLE’, ‘LIGHT_PROBE’, ‘SCENE’, ‘SIMULATION’, ‘SOUND’,
#  ‘SPEAKER’, ‘TEXT’, ‘TEXTURE’, ‘HAIR’, ‘POINTCLOUD’, ‘VOLUME’, ‘WINDOWMANAGER’, ‘WORLD’, ‘WORKSPACE’], default ‘OBJECT’
...
def get_driver_from_retarget_dictionary_fixed_slider_range(
    ...
    if dr_info:
        ...
        dp = dr_info.get('data_path', 'key_blocks["{}"].value'.format(target_shape_key_name))
        ...
        if variables:
            ...
            for v_name, v_data in variables.items():
                ...
                # single prob for other properties
                    ...
                    t.id_type = 'KEY'
                    t.id = shape_key_data
                    t.data_path = v_data.get('data_path', '')
        ...
        t.id_type = 'OBJECT'
        t.id = control_rig_id
        t.data_path = 'faceit_crig_targets["{}"].amplify'.format(expression_name)
