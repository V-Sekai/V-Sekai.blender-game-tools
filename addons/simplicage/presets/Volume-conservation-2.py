...
modifier.settings.shear_stiffness = 20.0
modifier.settings.bending_stiffness = 100.0
modifier.settings.pin_stiffness = 0.09999999403953552
modifier.settings.use_dynamic_mesh = True
modifier.settings.use_internal_springs = True
modifier.settings.internal_tension_stiffness = 0.09999999403953552
modifier.settings.internal_compression_stiffness = 0.1000000536441803
modifier.settings.internal_tension_stiffness_max = 0.30000001192092896
modifier.settings.internal_compression_stiffness_max = 1.0
...
modifier.settings.shear_stiffness_max = 25.0
