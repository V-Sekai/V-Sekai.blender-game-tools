...
modifier.settings.mass = 0.30000001192092896
...
modifier.settings.tension_damping = 5.0
modifier.settings.compression_damping = 5.0
modifier.settings.shear_damping = 5.0
modifier.settings.bending_damping = 0.5
...
modifier.settings.use_pressure = False
...
modifier.settings.pressure_factor = 1.0
modifier.settings.fluid_density = 0.0
modifier.settings.vertex_group_mass = 'Pin'
modifier.collision_settings.collision_quality = 2
...
modifier.settings.tension_stiffness_max = 15.0
modifier.settings.compression_stiffness_max = 15.0
modifier.settings.shear_stiffness_max = 5.0
