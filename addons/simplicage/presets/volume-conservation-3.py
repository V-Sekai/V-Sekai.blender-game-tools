...
modifier.settings.uniform_pressure_force = 0.07999992370605469
modifier.settings.shrink_min = 0.06422019004821777
modifier.settings.use_dynamic_mesh = False
...
modifier.settings.tension_stiffness_max = 204.29998779296875
